...
2. In ArcCatalog, load the osm file using the **Load OSM** tool in the *ArcGIS Editor for OpenStreetMap* toolset, located in your *System Toolboxes* in ArcGIS.
...
1. Open ArcMap and add the stylesheet. Customize > Style Manager > Styles... > Add Style to List...
